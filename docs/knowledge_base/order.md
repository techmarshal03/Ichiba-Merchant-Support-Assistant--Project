# Order Domain — Knowledge Base

This directory contains source documents ingested into the Azure AI Search index for the **order** domain.
...
```bash
python scripts/ingest_knowledge_base.py docs/knowledge_base/order/
```
...
- Include RMS navigation paths for procedural content (e.g., `RMS > Order > ...`)
