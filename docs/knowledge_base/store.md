...
This directory contains source documents ingested into the Azure AI Search index for the **store** domain.
...
```bash
python scripts/ingest_knowledge_base.py docs/knowledge_base/store/
```
...
- Include RMS navigation paths for procedural content (e.g., `RMS > Store > ...`)
