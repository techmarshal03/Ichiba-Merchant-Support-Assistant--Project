...
This directory contains source documents ingested into the Azure AI Search index for the **api** domain.
...
```bash
python scripts/ingest_knowledge_base.py docs/knowledge_base/api/
```
...
- Include RMS navigation paths for procedural content (e.g., `RMS > Api > ...`)
