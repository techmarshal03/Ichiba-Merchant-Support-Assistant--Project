# Policy Domain — Knowledge Base

This directory contains source documents ingested into the Azure AI Search index for the **policy** domain.
...
```bash
python scripts/ingest_knowledge_base.py docs/knowledge_base/policy/
```
...
- Include RMS navigation paths for procedural content (e.g., `RMS > Policy > ...`)
